...
const Home = () => {
    return (
        <div className='home-background white flex justify-center items-center flex-column ph2 h-100'>
            <h1 className='w-50-m text tc'>Some Heading</h1>
            <p className='w-50-m text tc'>It is a long established fact that a reader will be distracted by the
