...
const Home = () => {
    return (
        <div className='home-background white flex justify-center items-center flex-column ph2 h-100 pt4 pv6'>
            <h1 className='w-50-m text tc mt2'>Some Heading</h1>
            <p className='w-50-m text tc ph3'>It is a long established fact that a reader will be distracted by the
